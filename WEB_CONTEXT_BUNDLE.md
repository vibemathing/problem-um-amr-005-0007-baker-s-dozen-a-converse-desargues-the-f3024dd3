...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-005-0007-baker-s-dozen-a-converse-desargues-the-f3024dd3",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-005-0007-e1307486f70b",
        "url": "https://www.unsolvedmath.com/problems/AMR-005-0007"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Let $f(x,y)$ be a polynomial for which $0$ is a nonsingular value, let $\\gamma$ be an oval component of $f(x,y)=0$, and assume that $\\gamma_\\varepsilon=\\{f(x,y)=\\varepsilon\\}$ for $\\varepsilon>0$ foliates an outer neighborhood of $\\gamma$. Suppose that for every tangent line $\\ell$ to $\\gamma$, its intersections with the curves $\\gamma_\\varepsilon$ define a local projective involution on $\\ell$. Prove that $\\gamma$ is an ellipse and the curves $\\gamma_\\varepsilon$ form a pencil of conics.",
      "version": 1
    },
    "title": "Baker's Dozen — A converse Desargues theorem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "8131e1e841961be039efd5632234f2511a69b140410cc2e141bca8e3814b035e"
}
```
